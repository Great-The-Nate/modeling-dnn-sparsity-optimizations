...
parser.add_argument('-d', '--design_point', type=str, default= "FinalProject", help="design point file to run, any file name in ../arch_templates/HW_systems/design_points/...")
...
parser.add_argument('--density_degrees', nargs = "*", type=float, default=[1.0, 0.5], help='weight density degrees to run')
